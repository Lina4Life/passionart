...
async function testRegistrationFlow() {
    console.log('ðŸŽ¨ Testing PassionArt Registration Flow (Standard Properties)...\n');
    ...
    try {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="text-align: center; margin-bottom: 30px;">
                        <h1 style="color: #2563eb; margin: 0;">ðŸŽ¨ PassionArt</h1>
                        <p style="color: #666; margin: 5px 0;">Where Art Meets Passion</p>
                    </div>
                    
                    <h2 style="color: #1f2937;">Welcome ${testUser.firstname}!</h2>
                    
                    <p>Thank you for joining PassionArt, the ultimate platform connecting artists and art enthusiasts worldwide! ðŸŒŸ</p>
                    ...
                    <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 30px 0;">
                        <h3 style="color: #2563eb; margin-top: 0;">ðŸš€ What's Next?</h3>
                        <ul style="color: #4b5563; line-height: 1.6;">
                            <li>ðŸŽ¨ Browse incredible artwork from talented artists</li>
                            <li>ðŸ’¼ Create your artist profile and showcase your work</li>
                            <li>ðŸ¤ Connect with fellow art enthusiasts</li>
                            <li>ðŸ›’ Discover and purchase unique pieces</li>
                        </ul>
                    </div>
                    ...
                    <div style="text-align: center; color: #6b7280; font-size: 14px;">
                        <p>Welcome to our passionate art community! ðŸŽ¨</p>
        ...
        console.log('ðŸ‘‹ Contact Name:', `${contactResult.properties.firstname} ${contactResult.properties.lastname}`);
        ...
        console.log('ðŸ“ˆ Lead status changed to: VERIFIED');
        console.log('ðŸŽ¯ Lifecycle stage updated to: CUSTOMER');
        ...
        console.log('\nðŸŒŸ Your PassionArt platform is PRODUCTION READY!');
        console.log('ðŸš€ Users at http://217.154.119.33 will receive professional');
