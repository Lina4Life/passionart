// Usage: node scripts/map-stack.cjs <minified-file> <line> <column>
// Example: node scripts/map-stack.cjs dist/assets/index-DvYko-YX.js 82 71752
...
if(require.main===module){
  ...
  if(!minifiedFile||!line||!column){
    console.error('Usage: node scripts/map-stack.cjs <minified-file> <line> <column>');
    process.exit(1);
  }
